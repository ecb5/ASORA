...
},
{
  ...
  "number": "8.4.14",
  "title": "",
  "body": "    differentiation  implies is decreasing nearby  Show that if both and are differentiable on some interval , and that for some then there is an interval, , containing such that for every in where , .   "
},
{
