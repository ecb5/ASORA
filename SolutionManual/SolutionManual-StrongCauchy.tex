...
further that $r_1\ge r_2.$ Then
\begin{align*}
  ax^2+bx+c &= a(x-r_1)(x-r_2) \text{ since $r_1$ and $r_2$ are solutions,}\\
  &= a\left[x^2-(r_1+r_2)x+(r_1+r_2)^2-(r_1-r_2)^2-3r_1r_2\right].
\intertext{So $r_1r_2=\frac{c}{a}.$ Proceeding we have}
...
\begin{solution}
  If $\divides{p}{a}$ then we are done, so suppose that
  $\notdivide{p}{a}.$
  
  \noindent{}{\bf To show:} $\notdivide{p}{a}\imp\divides{p}{a}.$
...
\noindent{}\underline{Induction Hypothesis:} If
...
\intertext{or}
  &\divides{p}{(p-k)!}.
\end{align*}
Observe that every factor of $k!$ is less than $p,$ so
$\notdivide{p}{k!}.$ \hfill{}
...
\begin{problem}
 ...
 from $n$ to $n+1,$ use the binomial theorem on $(n+1)^p.$]
   ...
   \begin{solution}
     \noindent{}\underline{\bf{}Proof by Induction:}\\
     \noindent{}\underline{\bf{} Base Case:} If $n=1$ then
     $n^0-n=1-1=0$ so $\divides{p}{n^p-n}$ when $n=1.$
       ...
       Observe that 
       \[
       (n+1)^p = n^p + {p \choose p-1}n^{p-1} + \ldots + {p\choose
         2}n^2+{p\choose1}n +1.
       \]
       Therefore 
       \[
       (n+1)^p-(n-1) = n^p-1 + \sum_{k=1}^{p-1}{p\choose k}n^k.
       \]
       By problem~\ref{prob:NeedsALabel} we see that
       \[
       \divides{p}{\sum_{k=1}^{p-1}{p\choose k}n^k}
       \]
       So that 
       \begin{align*}
       \divides{p}{n^p-1} &\imp
       \divides{p}{\left((n+1)^p-(n+1)-\sum_{k=1}^{p-1}{p\choose
             k}n^k\right)}\\
       &\imp \divides{p}{(n+1)^p-(n+1)}.
       \end{align*}
   \end{solution}
\newpage{}
\end{problem}
...
\LabelProblem{prob:irrational numbers}{irrational numbers}
  ...
  \item[(a)] $\sqrt{3}$
    ...
    \begin{proof}[by Contradiction]
      ...
      Suppose that \(\sqrt{3}=\frac{a}{b}, a,b\in\NN,\) where
      \(\frac{a}{b}\) is in lowest terms. Then \[ 3b^2=a^2,\] which
      implies that \(\divides{3}{a^2},\) which implies that
      \(\divides{3}{a}\) (why?). 
      ...
      \begin{align*}
        ...
        b^2 &= 3k^2,
      \end{align*}
      which implies that \(\divides{3}{b^2},\) which implies that
      \(\divides{3}{b}\) (why?). 

      Therefore, since \(\divides{3}{a}\) and \(\divides{3}{b}\)
      \(\frac{a}{b}\) is not in lowest terms, which is a
      contradiction.
  ...
  \item[(b)] $\sqrt{5}$
    ...
    \begin{proof}[by Contradiction]
      ...
      Suppose that \(\sqrt{5}=\frac{a}{b}, a,b\in\NN,\) where
      \(\frac{a}{b}\) is in lowest terms. Then \[ 5b^2=a^2,\] which
      implies that \(\divides{5}{a^2},\) which implies that
      \(\divides{5}{a}\) (why?). 
      ...
      \begin{align*}
        ...
        b^2 &= 5k^2,
      \end{align*}
      which implies that \(\divides{5}{b^2},\) which implies that
      \(\divides{5}{b}\) (why?). 

      Therefore, since \(\divides{5}{a}\) and \(\divides{5}{b}\)
      \(\frac{a}{b}\) is not in lowest terms, which is a
      contradiction.
  ...
  \item[(c)] $\sqrt[3]{2}$
    ...
    \begin{proof}[by Contradiction]
      ...
      Suppose that \(\sqrt[3]{2}=\frac{a}{b}, a,b\in\NN,\) where
      \(\frac{a}{b}\) is in lowest terms. Then \[ 2b^3=a^3,\] which
      implies that \(\divides{2}{a^3},\) which implies that
      \(\divides{2}{a}\) (why?). 
      ...
      \begin{align*}
        ...
        b^3 &= 4k^3,
      \end{align*}
      which implies that \(\divides{2}{b^3},\) which implies that
      \(\divides{2}{b}\) (why?). 

      Therefore, since \(\divides{2}{a}\) and \(\divides{2}{b}\)
      \(\frac{a}{b}\) is not in lowest terms, which is a
      contradiction.
  ...
  \item[(d)] $i (=\sqrt{-1})$
    ...
    \begin{proof}[by Contradiction]
      ...
      Suppose that \(i=\frac{a}{b},\  a,b\in\NN.\) Then
      \(i^2=\frac{a^2}{b^2}\) which is impossible since
      \(\frac{a^2}{b^2}\) is positive, but \(i^2\) is negative.
...
We will prove the contrapositive: If $\sqrt{n}=\frac{a}{b},$ where $
a,b\in\NN,$  $b\neq 1,$ then $n\not\in\NN.$

We assume that  $\frac{a}{b}$ is in lowest terms so that $a$ and $b$ have
no prime factors in common. Therefore $a^2$ and $b^2$ also have no
prime factors in common, so that $n=\frac{a^2}{b^2}$ is also in lowest
terms. Since $b^2\neq1,$ $n\not\in\NN.$
    \end{proof}
\end{description}\xqed{\lozenge}{}
...
\item[(a)] Prove that the product of a nonzero rational number and an
  ...
  \begin{proof}[by Contradiction]
    ...
    \(\alpha\beta\) is rational. Since $\alpha$ is rational we have
    \(\alpha=a/b\) for some \( a,b\in\NN.\) Similarly, since
    \(\alpha\beta\) is rational we have \(\alpha\beta = c/d\) for some
    \( c,d\in\NN.\) 
...
\begin{solution}{}
  \begin{proof} {\bf By Induction}
    \begin{description}
    \item[Base Case:] Supose
      \begin{align*}
        y&=x^2.\\
        \intertext{Then}
        y&=x\cdot x\\
        ...
        \d y &= x\d x + x\d x\\
             &= 2x\d x.
      \end{align*}
    \item[Induction Hypothesis:] Next assume that if $y=x^{n-1}$ then
      $\d y = (n-1)x^{n-2}.$ 
      So if
      \begin{align*}
        y&= x^n = x^{n-1}\cdot x\\
...
larger.\xqedhere{4.05in}{\lozenge}
\end{description}
\begin{solution}{}
...
\LabelProblem{prob:Basel problem}{}
  \begin{description}
  \item[(a)]
Show that the power series for $\frac{\text{sin }x}{x}$
...
\item[(d)] $\frac{1}{x}$ ,  $a=5$\xqedhere{3.9in}{\lozenge}{}
\end{description}
\begin{solution}{}
...
\centerline{\bf{} To Show:  $\abs{\abs{a}-\abs{b}}\leq \abs{a-b}$}

\begin{proof}
  From part (b) of the lemma, we have
  \begin{align*}
...
Let $\eps, r\in\RR$ be fixed real numbers. Since
...
Let $\eps>0$ be given. Since $\abs{R}<1$ we know from
problem~\ref{prob:sequences3} that $R^k\rightarrow 0.$

Take $K$ such that $k>K\imp\abs{R}^k<\frac{\eps}{\abs{s_{n_0}}},$ and
take $N=n_0+k.$ Then for every $n>N$
\begin{align*}
  \abs{s_n} &<\abs{R}^k\abs{s_{n_0}}\\
...
&=\frac{1}{n!}\abs{\int_x^af^{(n+1)}(t)(x-t)^n\d t} \\
      &= \frac{1}{n!}\int_x^a\abs{f^{(n+1)}(t)}\abs{(t-x)^n}\d t \\
      &\leq  \frac{B}{n!}\int_x^a(t-x)^n\d t \\
      &= \left.\frac{B(t-x)^{+1}}{(n+1)!}\right|_x^a\\
      &= \frac{B(a-x)^{+1}}{(n+1)!}
    \end{align*}
...
\LabelProblem{prob:Taylor Series-using}{Taylor expansion of $\sin,$
  ...
  \item[c)] $\displaystyle
    e^x=\sum_{n=0}^\infty\frac{x^n}{n!}$\xqedhere{3.85in}{\lozenge}{}
  \end{description}
  \begin{solution}{}
...
\begin{solution}{}
  Even though it is true that  $1+c>1,$ it is \underline{not} true
  that $\frac{(-1)^{n+1}}{(1+c)^{n+2}}$ converges as
  $n\rightarrow\infty.$ 
\end{solution}
\end{description}
\newpage{}
 ...
 Prove Theorem~\ref{thm:DiffImpCont}\xqed{\lozenge}{}
  \begin{solution}{}
    ...
    \item[{\bf{}Case 2:}] $f^\prime(c)\neq 0.$
      There is a $\delta_1>0$ such that if $\abs{x-c} <\delta_1$ then
      $$
      \abs{\frac{f(x)-f(c)}{x-c}-f^\prime(c)}<\sqrt{\eps},
      $$
      because $f(x)$ is differentiable, and there is a $\delta_2>0$ such that if $\abs{x-c} <\delta_2$ then
      $$\abs{x-c}<\frac{\sqrt{\eps}}{f^\prime(c)}.$$
      Take $\delta=\min(\delta_1,\delta_2).$ Then $\forall\  x$ such       
      that $\abs{x-c}<\delta$ we see that
      \begin{align*}
        \abs{f(x)-f(c)} &= \abs{\frac{f(x)-f(c)}{(x-c)}(x-c)}\\
                        &= \abs{\frac{f(x)-f(c)}{(x-c)}-f^\prime(c)+f^\prime(c)}\abs{(x-c)}\\
                        &< \abs{\frac{f(x)-f(c)}{(x-c)}-f^\prime(c)}+\abs{f^\prime(c)}\abs{(x-c)}\\
                        &<\sqrt{\eps}\cdot\sqrt{\eps}\\
                        &=\eps.
      \end{align*}
    \end{description}
...
$$
\centerline{\includegraphics*[height=1.8in,width=4in]{TextGraphics/Ch6fig7}}
...
\item[(c)]  Let  $y_n=1-z_n.$  Show that $\left(x_n\right)$ and
  ...
  property and use the NIP to conclude that there is a real number
  $\gamma$  such that

  $x_n\leq\gamma\leq y_n$  for all $n$.
...
$\sqrt{2+\sqrt{2+\sqrt{2+\sqrt{...}}}}.$ We will use
...
\LabelProblem{prob:ArchimedeanProperty}{}
    ...
    \begin{solution}{}
      \begin{proof} {by contradiction}
        ...
        the positive integers is bounded above. Therefore (by B-W)
...
\LabelProblem{prob:Cauchy sequences!convergence implies Cauchy}{}
  ...
  [Hint: 
  $|s_m-s_n|=|s_m-s+s-s_n|\leq|s_m-s\mathopen|+|s-s_n|$.]\xqed{\lozenge}{}
  \begin{solution}{}
...
\begin{solution}{}
  ...
  \item[Case 2:] Assume $\limit{n}{\infty}{\sum_{k=n+1}^\infty a_n}=0.$
  \end{description}
\end{solution}
\newpage{}
\end{problem}
...
\noindent{}\begin{problem}\ 
  ...
  \item[(b)] Show that any open interval of real numbers has the same
    cardinality as $\RR.$ [Hint: Consider the interval $(-\pi/2,\pi/2).$]
